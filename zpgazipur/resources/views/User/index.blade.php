			...
			<div style=" background-color: #EFEFEF;border: 1px solid #CCCCCC;margin: 20px 0;padding: 10px;" class="row">
				...
				<div class="block gap">
					...
					<ul class="dpe-flexible-posts">
						<img width="186" height="114" src="{{asset('images/uploads')}}/{{$cat->image}}" class="attachment-medium wp-post-image" alt="Social work Final">
				...
				@empty
				@endforelse
				<h5 style="float:left;margin:-3px 5px 0 0; font-weight:bold;">খবর:</h5>
