      ...
      <div class="panel-body">
        <form action="" method="post" enctype="multipart/form-data" id="form-user" class="form-horizontal">
          ...
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="date" name="startsate" placeholder="Notice Date" id="input-username" class="form-control" value="{{$notice->noticedate}}">
            	<div class="text-danger"></div>
          	</div>
          </div>
          <div class="form-group required has-error">
          ...
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="file" name="attachment" placeholder="Attachment" id="input-username" class="form-control">
            	<div class="text-danger"></div>
          	</div>
          </div>
          @empty
